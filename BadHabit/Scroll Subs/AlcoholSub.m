...
- (IBAction)add:(id)sender
{
    ...
    [dictToMake setValue:[NSString stringWithFormat:@"%f",realPrice] forKey:@"price"];
    [dictToMake setValue:@"Alcohol" forKey:@"tableID"];
    [dictToMake setValue:[NSString stringWithFormat:@"5"] forKey:@"cc"];
...
{
    self = [[[NSBundle mainBundle] loadNibNamed:@"AlcoholSub" owner:nil options:nil] objectAtIndex:0];
